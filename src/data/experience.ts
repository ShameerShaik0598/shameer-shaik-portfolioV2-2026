...
export const experiences: ExperienceItem[] = [
  {
    ...
    current: true,
    bullets: [
      "Delivered 3 React.js production applications and automated ETL pipelines processing 50K+ daily records — built the entire engineering and analytics function from scratch.",
